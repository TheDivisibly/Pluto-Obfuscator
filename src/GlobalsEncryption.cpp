...
void GlobalsEncryption::insertArrayDecryption(Module &M, EncryptedGV encGV) {
    ...
    Value *ele = builder.CreateGEP(encGV.GV->getValueType(), encGV.GV,
...
PreservedAnalyses GlobalsEncryptionPass::run(Module &M,
                                             ModuleAnalysisManager &AM) {
  GlobalsEncryption ge(1);
  ge.runOnModule(M);
